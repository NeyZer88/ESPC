...
int InitTime()
{
	...
	for (z=0;z<8;z++)
	{
		...
		{
			case 0:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/0.pbm", "r");
				break;
			case 1:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/1.pbm", "r");
				break;
			case 2:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/2.pbm", "r");
				break;
			case 3:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/3.pbm", "r");
				break;
			case 4:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/4.pbm", "r");
				break;
			case 5:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/5.pbm", "r");
				break;
			case 6:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/6.pbm", "r");
				break;
			case 7:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/7.pbm", "r");
				break;
			case 8:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/8.pbm", "r");
				break;
			case 9:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/9.pbm", "r");
				break;
			case 20:
				fichier1 = fopen("/home/pthn/EXIASAVER_HOME/EXIASAVER2/EXIASAVER2_PBM/:.pbm", "r");
				break;
		}
